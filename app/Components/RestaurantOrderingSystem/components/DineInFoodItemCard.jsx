...
const DineInFoodItemCard = ({
  ...
  return (
    <div className="bg-white border flex-col md:flex-row gap-3 transition-all duration-200 hover:outline hover:outline-red-500 border-gray-300 p-4 flex items-center rounded-lg shadow-sm overflow-hidden">
      {/* Image */}
