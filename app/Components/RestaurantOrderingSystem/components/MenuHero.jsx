  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('img/bread_banner-scaled.jpg'), linear-gradient(to right, #ffe4ec, #fff7ed)",
      ...
      >
        <div className="container mx-auto relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <h2 className="text-black font-bold leading-tight text-4xl md:text-5xl uppercase font-barlow mb-8">
              {title}
            </h2>
