...
const CheckoutPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!orderDetails.billingAddress?.street?.trim())
      errors.billingStreet = "Billing street address is required";
    if (!orderDetails.billingAddress?.city?.trim())
      errors.billingCity = "Billing city is required";
    if (!orderDetails.billingAddress?.state?.trim())
      errors.billingState = "Billing state is required";
    if (!orderDetails.billingAddress?.zipCode?.trim())
    ...
    if (!sameAsBilling) {
      ...
      if (!orderDetails.shippingName?.trim())
        errors.shippingName = "Shipping recipient name is required";
      if (!orderDetails.shippingPhone?.trim())
        errors.shippingPhone = "Shipping recipient phone is required";
      if (!orderDetails.shippingEmail?.trim())
        errors.shippingEmail = "Shipping recipient email is required";

      // Validate shipping address
      if (!orderDetails.shippingAddress?.street?.trim())
        errors.shippingStreet = "Shipping street address is required";
      if (!orderDetails.shippingAddress?.city?.trim())
        errors.shippingCity = "Shipping city is required";
      if (!orderDetails.shippingAddress?.state?.trim())
        errors.shippingState = "Shipping state is required";
      if (!orderDetails.shippingAddress?.zipCode?.trim())
  ...
  return (
    <div
      className="bg-white min-h-screen checkout-input-rounded"
    ...
    >
      ...
      <div className="container mx-auto  rounded-2xl  border my-14 border-gray-200 p-4 lg:p-10 space-y-14">
        ...
        <div className=" ">
          ...
          <div className="flex flex-wrap gap-4 sm:space-x-4 sm:flex-nowrap">
            {/* Delivery Option */}
            <div
              className={`flex-1 min-w-[250px] px-5 py-4 rounded-md border cursor-pointer transition-all duration-200 ${
                orderType === "delivery"
            ...
            >
              <div className="flex items-center space-x-3 ">
                <label className="inline-flex items-center gap-4 cursor-pointer">
                  ...
                  <Truck
                    size={18}
                    className="text-gray-400 peer-checked:text-red-500 transition"
                  />
                ...
                >
                  <div className="flex flex-col">
                    ...
                    <input
                      ...
                      className={`px-3 py-3 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none text-sm text-black ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="w-full">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleBillingPersonalInfoChange("name", e.target.value)
                    }
                    placeholder="Enter your full name"
                    className={`w-full pl-12 pr-4 py-4 bg-gray-50 border-2 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 focus:bg-white transition-all duration-200 outline-none text-black ${
                      formErrors.name
              ...
              <div className="w-full">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleBillingPersonalInfoChange("phone", e.target.value)
                    }
              ...
              <div className="col-span-1 md:col-span-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleBillingPersonalInfoChange("email", e.target.value)
                    }
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-4 bg-gray-50 border-2 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 focus:bg-white transition-all duration-200 outline-none text-black ${
          ...
          <div className="bg-white rounded-2xl border border-gray-200 px-4 md:px-8 py-8">
            <div className="flex flex-col md:flex-row justify-start items-start gap-4 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateOrderDetails("shippingName", e.target.value)
                      }
                      placeholder="Enter recipient full name"
                      className={`w-full pl-12 pr-4 py-4 bg-gray-50 border-2 rounded-2xl focus:ring-4 focus:ring-green-100 focus:border-green-500 focus:bg-white transition-all duration-200 outline-none text-black ${
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateOrderDetails("shippingPhone", e.target.value)
                      }
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateOrderDetails("shippingEmail", e.target.value)
                      }
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Enter city"
                    className={`w-full px-4 py-4 bg-gray-50 border-2 rounded-2xl focus:ring-4 focus:ring-green-100 focus:border-green-500 focus:bg-white transition-all duration-200 outline-none text-black ${
            ...
            {sameAsBilling && (
              <div className="bg-green-50 border border-green-200 rounded-2xl p-4">
                <div className="flex flex-col md:flex-row justify-start items-start gap-4 space-x-3">
        ...
        <div className="bg-white rounded-2xl  border border-gray-200 px-4 md:px-8 py-8 mb-8">
          <div className="flex flex-col md:flex-row justify-start items-start gap-4 mb-6">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-2xl p-5 shadow-sm">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-blue-800 capitalize text-lg">
                      {orderType}
                    </p>
              ...
              <div className="mt-4">
                ...
                <div className="flex items-center gap-4 flex-wrap">
                  {/* Bank Transfer */}
                  <div
                    className={`w-60 px-5 py-4 rounded-md border cursor-pointer transition-all duration-200 ${
                      paymentMethod === "bank"
                        ? "border-red-500 bg-red-50"
                        : "border-gray-200 bg-gray-50"
                    }`}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 overflow-y-auto max-h-[40rem]">
                {cart.map((item) => (
                  <div
                    key={item.id}
                    className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl border border-orange-100 shadow-sm hover:shadow-lg transition-shadow"
                  >
                    {/* Product Image */}
                    <div className="flex-shrink-0 w-full sm:w-20 h-40 sm:h-20 rounded-xl overflow-hidden border border-gray-200 bg-white flex items-center justify-center">
                      <img
                    ...
                    {/* Price */}
                    <div className="text-left sm:text-right min-w-[80px] w-full sm:w-auto">
