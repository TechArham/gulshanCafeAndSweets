                ...
                <div className="container py-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            <button
                                onClick={handleBackToMenu}
                                className="p-3 hover:bg-orange-50 rounded-2xl transition-all duration-200 cursor-pointer group"
                            >
                                <ArrowLeft size={20} className="text-gray-600 group-hover:text-orange-600 transition-colors" />
                            </button>
                            <div className="flex items-center space-x-3">
                                <div className="bg-gradient-to-r from-orange-500 to-red-500 p-2 rounded-2xl">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-12 pr-4 py-4 bg-gray-50 border-2 rounded-2xl focus:ring-4 focus:ring-orange-100 focus:border-orange-500 focus:bg-white transition-all duration-200 outline-none ${formErrors.tableNumber ? 'border-red-300 bg-red-50' : 'border-gray-200'
                                                }`}
                                        />
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-12 pr-4 py-4 bg-gray-50 border-2 rounded-2xl focus:ring-4 focus:ring-orange-100 focus:border-orange-500 focus:bg-white transition-all duration-200 outline-none ${formErrors.name ? 'border-red-300 bg-red-50' : 'border-gray-200'
                                                }`}
                                        />
                                        {formErrors.name && (
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-12 pr-4 py-4 bg-gray-50 border-2 rounded-2xl focus:ring-4 focus:ring-orange-100 focus:border-orange-500 focus:bg-white transition-all duration-200 outline-none ${formErrors.phone ? 'border-red-300 bg-red-50' : 'border-gray-200'
                                                }`}
                                        />
                                        {formErrors.phone && (
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-12 pr-4 py-4 bg-gray-50 border-2 rounded-2xl focus:ring-4 focus:ring-orange-100 focus:border-orange-500 focus:bg-white transition-all duration-200 outline-none ${formErrors.email ? 'border-red-300 bg-red-50' : 'border-gray-200'
                                                }`}
                                        />
                                        {formErrors.email && (
